  ...
  const labels = {
    ...
    status: () =>
      ({
        ...
        invited: t('listings.status.invited'),
        visited: t('listings.status.visited'),
        documents_sent: t('listings.status.documentsSent'),
        rejected: t('listings.filterStatusRejected'),
        not_invited: t('listings.status.notInvited'),
